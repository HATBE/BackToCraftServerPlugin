    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        switch(args.length) {
            case 0:
                ...
                if(!(senderPlayer.hasPermission("btc.heal"))) {
                ...
                senderPlayer.sendMessage("Healed");
                break;
            case 1:
                ...
                if(sender instanceof Player) {
                    senderPlayer = (Player) sender;
                    if(senderPlayer.hasPermission("btc.heal.others")) {
                        canSend = true;
                    }
                }
                ...
                senderPlayer.sendMessage(String.format("Healed %s", targetPlayer.getDisplayName()));
                targetPlayer.sendMessage("Healed");
                break;
            default:
