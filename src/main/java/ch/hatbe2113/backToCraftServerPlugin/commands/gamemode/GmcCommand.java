    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        switch(args.length) {
            case 0:
                ...
                if(!(senderPlayer.hasPermission("btc.gmc"))) {
                ...
                senderPlayer.sendMessage("Your gamemode has changed to creative");
                break;
            case 1:
                ...
                if(sender instanceof Player) {
                    senderPlayer = (Player) sender;
                    if(senderPlayer.hasPermission("btc.gmc.others")) {
                        canSend = true;
                    }
                }
                ...
                targetPlayer.sendMessage("Your gamemode has changed to creative");
                sender.sendMessage(String.format("%ss gamemode has changed to creative", targetPlayer.getDisplayName()));
                break;
            default:
