    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        switch(args.length) {
            case 0:
                ...
                if(!(senderPlayer.hasPermission("btc.gmsp"))) {
                ...
                senderPlayer.sendMessage("Your gamemode has changed to spectator");
                break;
            case 1:
                ...
                if(sender instanceof Player) {
                    senderPlayer = (Player) sender;
                    if(senderPlayer.hasPermission("btc.gmsp.others")) {
                        canSend = true;
                    }
                }
                ...
                sender.sendMessage(String.format("%ss gamemode has changed to spectator", targetPlayer.getDisplayName()));
                break;
            default:
