    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        switch(args.length) {
            case 0:
                ...
                if(!(senderPlayer.hasPermission("btc.gms"))) {
                ...
                senderPlayer.sendMessage("Your gamemode has changed to survival");
                break;
            case 1:
                ...
                if(sender instanceof Player) {
                    senderPlayer = (Player) sender;
                    if(senderPlayer.hasPermission("btc.gms.others")) {
                        canSend = true;
                    }
                }
                ...
                targetPlayer.sendMessage("Your gamemode has changed to survival");
                sender.sendMessage(String.format("%ss gamemode has changed to survival", targetPlayer.getDisplayName()));
                break;
            default:
